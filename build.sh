...
then
	...
	do
		...
		then
		    ...
		    CONFIG_EXTRA_CFLAGS="-arch $ARCH -isysroot $MACOSX_SDK_DIR -isystem $MACOSX_SDK_DIR/System/iOSSupport/usr/include -iframework $MACOSX_SDK_DIR/System/iOSSupport/System/Library/Frameworks"
		else
